...
def main():
    trainloader, validloader, testloader, train_data = my_utility.load_data(where)
    model, criterion = my_model.setup_network(struct,dropout,hidden_units,lr,power)
    ...
    #my_model.save_checkpoint(traindata,model,path,struct,hidden_units,dropout,lr)
